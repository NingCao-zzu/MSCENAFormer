...
parser.add_argument('--result_dir', default='./results-ntire0_b2/', type=str, help='path to results saving')
parser.add_argument('--dataset', default='NH-HAZE', type=str, help='dataset name')
